...
import generics.expression.exception.parserException.BracketException;
import generics.expression.exception.parserException.OperandException;
import generics.expression.exception.parserException.OperationException;
import generics.expression.exception.parserException.ParserException;
import generics.expression.generic.mode.AbstractMode;
import generics.expression.operation.*;
import generics.expression.token.Token;
import generics.expression.token.TokenType;
import generics.expression.token.Tokenizer;
